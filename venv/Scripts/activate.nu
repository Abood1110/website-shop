...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\A-y-A\Desktop\Django_project\first_pro\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\A-y-A\Desktop\Django_project\first_pro\venv\Scripts\deactivate.nu'
